...
class DialogAITeacher:
    ...
    def generate_lesson_step(self, lesson_topic, user_level, conversation_history, current_step):
        ...
        3. Будь немного креативным в подаче
        4. Не будь слишком формальным
        5. Отвечай на русском языке
        6. Будь кратким, но информативным (максимум 3-4 предложения)
        7. МИНИМУМ ВОПРОСОВ - только для проверки понимания (1 на 5 сообщений)
        8. ПРОДВИГАЙСЯ ВПЕРЕД - не зацикливайся на одном аспекте
        9. СТРУКТУРИРОВАННЫЙ ПОДХОД - теория → примеры → применение
